    ...
    <Box>
        <template #header
            ...
            <span
                ...
                class="text-sm dark:bg-green-900 dark:text-green-200 bg-green-200 text-green-900 p-1 rounded-md uppercase ml-1"
                >accepted</span
            ></template
        >
        ...
        <section class="flex items-center justify-between">
            ...
            <div>
                <Link
                    v-if="!isSold"
                    :href="route('seller.offer.accept', { offer: offer.id })"
